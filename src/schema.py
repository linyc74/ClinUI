...
class NycuOsccSchema(Schema):
    ...
    OTHER_PRIMARY_TUMOR_DIAGNOSIS_DATE = 'Other Primary Tumor Diagnosis Date'
    OTHER_PRIMARY_TUMOR_SITE = 'Other Primary Tumor Site'
    ...
    DISPLAY_COLUMNS = [
        ...
        OTHER_PRIMARY_TUMOR_DIAGNOSIS_DATE,
        OTHER_PRIMARY_TUMOR_SITE,
    ]
